    ...
    <v-card-text>
      ...
      >
        ...
        <template v-slot:[`item.jamMasuk`]="{ item }">
          {{ momentDateFormat(item.jamMasuk, 'HH:mm') }}
        </template>
        <template v-slot:[`item.jamPulang`]="{ item }">
          {{ momentDateFormat(item.jamPulang, 'HH:mm') }}
        </template>
        <template v-slot:[`item.jamAwalScanMasuk`]="{ item }">
          {{ momentDateFormat(item.jamAwalScanMasuk, 'HH:mm') }}
        </template>
        <template v-slot:[`item.jamAwalScanPulang`]="{ item }">
          {{ momentDateFormat(item.jamAwalScanPulang, 'HH:mm') }}
        </template>
