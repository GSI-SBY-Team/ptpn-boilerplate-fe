  ...
  <v-card>
    ...
    <v-card-text>
      ...
      >
        ...
        <template v-slot:[`item.mandors`]="{ item }">
          <span
           v-if="item.ketMandoring == 'mandor'"
            style="color: blue"
            class="text-blue-600 underline cursor-pointer"
            @click="handleClickNama(item)"
          >
            {{ item.nikMandor }} - {{ item.mandor }}
          </span>
          <span
           v-if="item.ketMandoring == 'no_mandor'"
            style="color: red"
            class="text-red-600 "
          >
            {{ item.nikMandor }} - {{ item.mandor }}
        ...
        <template v-slot:[`item.jamKeluar`]="{ item }">
