...
export default {
  ...
  mounted() {
    ...
    if (dataUser.role.id == "HA04") {
      //02reg08unit04afd
      this.filter.idAfdeling = dataUser.personData.afdelingId;
  ...
  methods: {
    ...
    handleExport() {
      this.$emit("handleExport", {
        ...
        afdelingId: this.filter.idAfdeling,
        komoditasId: this.filter.idKomoditas,
      });
    },
    handleAddItem() {
      this.$emit("addItem");
