    ...
    <v-card-text>
      ...
      >
        ...
        <template v-slot:[`item.jamDatang`]="{ item }">
          {{ minimal_date_format_no_timezone(item.jamDatang) }}
        </template>
        ...
        <template v-slot:[`item.startGiling`]="{ item }">
          {{ backEndTimeFormat(item.startGiling) }}
        </template>
        <template v-slot:[`item.stopGiling`]="{ item }">
          {{ backEndTimeFormat(item.stopGiling) }}
        </template>
        <template v-slot:[`item.stopOksidasi`]="{ item }">
          {{ backEndTimeFormat(item.stopOksidasi) }}
        </template>
        <template v-slot:[`item.startOksidasi`]="{ item }">
          {{ backEndTimeFormat(item.startOksidasi) }}
        </template>
