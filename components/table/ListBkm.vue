<template>
  <v-card>
    ...
    <v-card-text>
     ...
     <v-col cols="auto">
          <v-btn color="#5D87FF" style="color:white;" variant="flat" @click.prevent="handleGenerateBkm"
            ><v-icon>mdi-refresh</v-icon> Generate BKM</v-btn
          >
        </v-col>
         <v-col cols="auto">
          <v-btn color="#40c75f" style="color:white;" variant="flat" @click.prevent="handleExportExcel"
            ><v-icon>mdi-file-excel</v-icon> Export Excel</v-btn
          >
        </v-col>
        <v-col cols="auto">
    <v-btn color="#40c75f" style="color: white;" variant="flat" @click.prevent="handleImportBkm">
      <v-icon>mdi-file-upload</v-icon> Import Excel
    </v-btn>
  </v-col>
  </v-row>
  <br>
