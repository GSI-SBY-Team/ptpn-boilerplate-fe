  ...
  methods: {
    ...
    handleExport() {
      this.$emit("handleExport", {
        pabrikId: this.filter.pabrikId,
        kategoriId: this.filter.kategoriId,
        satuanId: this.filter.satuanId,
      });
    },
    handleAddItem() {
      this.$emit("addItem");
