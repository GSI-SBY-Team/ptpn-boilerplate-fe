        ...
        <template v-slot:tfoot>
          <tr>
            ...
            <td class="text-right pr-4">
              <strong>{{ tableData.meta.totalPanenManual }}</strong>
            </td>
            <td class="text-right pr-4">
              <strong>{{ tableData.meta.totalPanenGunting }}</strong>
            </td>
            <td class="text-right pr-4">
              <strong>{{ tableData.meta.totalPanenMesinGroup }}</strong>
            </td>
            <td class="text-right pr-4">
              <strong>{{ tableData.meta.totalPanenMesinIndividu }}</strong>
            </td>
            <td class="text-right pr-4">
              <strong>{{ tableData.meta.totalPanen }}</strong>
            </td>
          </tr>
        </template>
