    ...
    <v-card-text>
      ...
      <v-row>
        ...
        <v-col cols="12" md="2">
          <v-autocomplete
            label="Periode"
            v-model="filter.periodePenilaian"
            :items="listPeriode"
            item-value="value"
            item-title="text"
            color="primary"
  ...
  methods: {
    ...
    handleApplyFilter() {
      ...
      this.filter = {
        ...
        bulanPenilaian: filter.bulanPenilaian,
        periodePenilaian: filter.periodePenilaian,
        t: Date.now(),
      };
      this.$router.replace({
    ...
    handleRefreshItems() {
      ...
      resetFilter.bulanPenilaian = null;
      resetFilter.periodePenilaian = null;
    ...
    handleExport() {
      this.$emit("handleExport", {
        ...
        bulanPenilaian: this.filter.bulanPenilaian,
        periodePenilaian: this.filter.periodePenilaian,
      });
    },
