                ...
                <template v-slot:default>
                    ...
                    <tbody>
                        <tr class="month-item">
                            ...
                            <td><ClientOnly><apexchart type="area" height="35" width="95" :options="chartoption1" :series="Chart1"> </apexchart></ClientOnly></td>
                        </tr>
                        <tr class="month-item">
                            <td>
                                <div class="d-flex align-center">
                            ...
                            <td><ClientOnly><apexchart type="area" height="35" width="95" :options="chartoption2" :series="Chart2"> </apexchart></ClientOnly></td>
                        </tr>
                        <tr class="month-item">
                            <td>
                                <div class="d-flex align-center">
                            ...
                            <td><h4 class="text-body-1">$3.5K</h4></td>
                            <td><ClientOnly><apexchart type="area" height="35" width="95" :options="chartoption3" :series="Chart3"></apexchart></ClientOnly></td>
                        </tr>
                        <tr class="month-item">
                            <td>
                                <div class="d-flex align-center">
                            ...
                            <td><h4 class="text-body-1">$3.5K</h4></td>
                            <td><ClientOnly><apexchart type="area" height="35" width="95" :options="chartoption4" :series="Chart4"> </apexchart></ClientOnly></td>
                        </tr>
                    </tbody>
                </template>
            </v-table>
