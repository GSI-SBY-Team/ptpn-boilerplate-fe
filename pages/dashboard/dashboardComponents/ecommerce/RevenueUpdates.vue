        ...
        <v-card-item>
            ...
            <div class="d-flex align-center mt-6">
                ...
                <h6 class="text-subtitle-2 textSecondary pl-5 d-flex align-center">
                    <v-icon icon="mdi mdi-checkbox-blank-circle" class="mr-2" size="10" color="secondary"></v-icon>
                    Fashionware
                </h6>
            </div>

            <ClientOnly><apexchart class="pt-1 revenuechart" type="bar" height="320" :options="chartOptions"
                :series="seriescolumnchart"> </apexchart></ClientOnly>
        </v-card-item>
    </v-card>
</template>
